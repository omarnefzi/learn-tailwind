...
import { Link } from 'react-router-dom';
 ...
 const CustomCard = ({id,title,image,price,product}) =>{
...
return(
  ...
  <div className="max-w-md w-full bg-[#1e293b] shadow-lg rounded-xl p-6 mb-5">
    <div className="flex flex-col ">
      <div className>
        <div className="relative h-62 w-full mb-3">
          ...
          <img 
            // src='https://media.istockphoto.com/id/875820218/fr/photo/manteaux-color%C3%A9s-dans-le-charity-shop.jpg?b=1&s=612x612&w=0&k=20&c=GTugjnWknpFRdFgjAcR-2q78T55g1kNAMN0bGyeaPRM='
            src={image}
            alt="Just a flower"
            className=" w-full h-80   object-fill  rounded-2xl"
          />
        </div>
        <div className="flex-auto justify-evenly">
          ...
          <div className="flex space-x-2 text-sm font-medium justify-start">
            <button onClick={()=>dispatch(addToCard(product))} className="transition ease-in duration-300 inline-flex items-center text-sm font-medium mb-2 md:mb-0 bg-[#a855f7] px-5 py-2 hover:shadow-lg tracking-wider text-white rounded-full hover:bg-[#9333ea] ">
              <span>Add Cart</span>
            </button>
            <Link to={`/products/${id}`}>
