...
import { register } from '../rtk/userSlice'
            ...
            <div className="flex -mx-3">
              <div className="w-1/2 px-3 mb-5">
                ...
                <div className="flex">
                  ...
                  <input onChange={handleChange} name='firstName' type="text" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="John" />
                </div>
              </div>
              <div className="w-1/2 px-3 mb-5">
                ...
                <div className="flex">
                  <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-account-outline text-gray-400 text-lg" /></div>
                  <input onChange={handleChange} name='lastName' type="text" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Smith" />
                </div>
              </div>
            </div>
            <div className="flex -mx-3">
            ...
            <div className="flex -mx-3">
              <div className="w-full px-3 mb-12">
                ...
                <div className="flex">
                  ...
                  <input onChange={handleChange} name='password' type="password" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="************" />
                </div>
              </div>
            </div>
            <div className="flex -mx-3">
