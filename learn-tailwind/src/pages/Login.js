    ...
    <div className="w-full py-6 z-20">
      ...
      <form  onSubmit={(e) => handleSubmit(e)} className="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
        <div className="pb-2 pt-4">
          <input onChange={handleChanging} type="email" name="email" id="email" placeholder="Email" className="block w-full p-4 text-lg rounded-sm bg-black" />
        </div>
        <div className="pb-2 pt-4">
          <input onChange={handleChanging} className="block w-full p-4 text-lg rounded-sm bg-black" type="password" name="password" id="password" placeholder="Password" />
        </div>
